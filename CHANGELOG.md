...
- Уведомления в Telegram: бот пишет о найденном обновлении, применённом обновлении и об ошибках. Набор событий выбирается галочками, рутинные проверки без изменений по умолчанию выключены.
